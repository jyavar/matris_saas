  ...
  async updateTodo(
    ...
    try {
      ...
      if (validatedData.title !== undefined)
        updatePayload.task = validatedData.title
      if (validatedData.completed !== undefined)
        updatePayload.is_completed = validatedData.completed
      if (validatedData.priority !== undefined)
        updatePayload.priority = validatedData.priority
      if (validatedData.description !== undefined)
        updatePayload.description = validatedData.description
      if (validatedData.dueDate !== undefined)
        updatePayload.due_date = validatedData.dueDate
