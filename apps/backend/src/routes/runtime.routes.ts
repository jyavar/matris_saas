...
export const runtimeRoutes = [
  ...
  { method: 'POST', path: '/agents/:name/start', handler: runtimeController.startAgent },
  { method: 'POST', path: '/agents/:name/stop', handler: runtimeController.stopAgent },
  { method: 'GET', path: '/agents/:name/status', handler: runtimeController.getAgentStatus },
  { method: 'GET', path: '/agents/:name/logs', handler: runtimeController.getAgentLogs },
  { method: 'POST', path: '/agents/:name/run', handler: runtimeController.runAgent },
  ...
  { method: 'DELETE', path: '/tasks/:id', handler: runtimeController.deleteTask },
  { method: 'POST', path: '/tasks/:id/execute', handler: runtimeController.executeTask },
  { method: 'GET', path: '/tasks/:id/result', handler: runtimeController.getTaskResult },
]
