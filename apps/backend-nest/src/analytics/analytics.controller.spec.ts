...
describe('AnalyticsController', () => {
  ...
  describe('trackEvent', () => {
    ...
    it('should handle trackEvent service errors', async () => {
      const eventData = {
  ...
  describe('trackMetric', () => {
    ...
    it('should handle trackMetric service errors', async () => {
      const metricData = {
  ...
  describe('getAnalyticsSummary', () => {
    it('should return analytics summary with date range', async () => {
      ...
      expect(analyticsService.getAnalyticsSummary).toHaveBeenCalledWith(startDate, endDate)
      expect(result).toEqual({
        success: true,
    ...
    it('should return analytics summary without date range', async () => {
      ...
      expect(analyticsService.getAnalyticsSummary).toHaveBeenCalledWith(undefined, undefined)
      expect(result).toEqual({
        success: true,
        data: expectedSummary,
      })
    ...
    it('should handle getAnalyticsSummary service errors', async () => {
      const startDate = 'invalid-date'
      const endDate = '2024-01-31'

      const errorMessage = 'Invalid date format'
      analyticsService.getAnalyticsSummary.mockRejectedValue(new Error(errorMessage))

      await expect(controller.getAnalyticsSummary(startDate, endDate)).rejects.toThrow(errorMessage)
      expect(analyticsService.getAnalyticsSummary).toHaveBeenCalledWith(startDate, endDate)
    })
  })
