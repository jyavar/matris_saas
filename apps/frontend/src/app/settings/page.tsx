  ...
  return (
    <section className="min-h-[60vh] flex flex-col items-center justify-center py-16 px-4">
      ...
      <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl text-center mb-8">
        Personaliza preferencias, seguridad y notificaciones de tu cuenta y organización en STRATO Core OS™.<br /><br />
        {/* TODO: Implementar gestión de perfil, roles, permisos y notificaciones. */}
      </p>
    </section>
  )
} 